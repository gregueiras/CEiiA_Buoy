function ScoreBoardGameControl (){
	var score = 0;
	var POINT_GAME_INCREASE = 30;
	var POINT_GAME_DECREASE =10
	var TEXT_SCORE = "Pontos: "

	var TOTAL_CORRECT = 14;
	var corrects = 0;
	...
	this.incrementScore =  function (){
		corrects++;
		score+= POINT_GAME_INCREASE;
		if (corrects ==  TOTAL_CORRECT){
			alert("Fim de Jogo! Recebes " + score + "perolas.");

		}
	}

	this.decrementScore =  function (){
		score-= POINT_GAME_DECREASE;
	}
}

function Card(picture){
	var FOLDER_IMAGES = '../../static/challenge/resources/'
...
function BuilderCardGame(){
	var pictures = new Array ('14.png','14.png',
		'1.png','1.png',
		'2.png','2.png',
		'3.png','3.png',
		'4.png','4.png',
